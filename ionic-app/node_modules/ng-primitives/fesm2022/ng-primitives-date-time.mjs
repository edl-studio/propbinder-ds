...
const NgpDateAdapterToken = new InjectionToken('NgpDateAdapterToken');
/**
 * Inject the DateAdapter instance
 */
function injectDateAdapter() {
    return (inject(NgpDateAdapterToken, { optional: true }) ||
...
//# sourceMappingURL=ng-primitives-date-time.mjs.map
