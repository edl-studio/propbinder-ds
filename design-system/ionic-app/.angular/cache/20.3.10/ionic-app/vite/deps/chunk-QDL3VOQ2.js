...
// node_modules/ng-primitives/fesm2022/ng-primitives-portal.mjs
var NgpOverlayContextToken = new InjectionToken("NgpOverlayContextToken");
...
var NgpComponentPortal = class extends NgpPortal {
   ...
   */
  attach(container) {
    const domOutlet = new DomPortalOutlet(container, void 0, void 0, this.injector);
  ...
  detach() {
    return __async(this, null, function* () {
      ...
      yield this.exitAnimationRef?.exit();
      if (this.viewRef) {
...
var NgpTemplatePortal = class extends NgpPortal {
  ...
  detach() {
    return __async(this, null, function* () {
      ...
      this.isDestroying = true;
      yield Promise.all(this.exitAnimationRefs.map((ref) => ref.exit()));
      if (this.viewRef) {
        this.viewRef.destroy();
        this.viewRef = null;
      }
...
var BlockScrollStrategy = class {
  constructor(viewportRuler, document2) {
...
var NgpOverlay = class _NgpOverlay {
  /**
  ...
  constructor(config) {
    ...
    this.parentOverlay = inject(_NgpOverlay, { optional: true });
    this.portal = signal(null);
    this.position = signal({
      x: void 0,
      y: void 0
    });
    this.isPositioned = computed(() => this.position().x !== void 0 && this.position().y !== void 0);
    this.triggerWidth = signal(null);
    this.transformOrigin = signal("center center");
    this.finalPlacement = signal(void 0);
    this.isOpen = signal(false);
    this.id = signal(uniqueId("ngp-overlay"));
    this.ariaDescribedBy = computed(() => this.isOpen() ? this.id() : void 0);
    ...
    fromResizeEvent(this.config.triggerElement).pipe(safeTakeUntilDestroyed(this.destroyRef)).subscribe(({ width, height }) => {
    ...
    fromEvent(this.document, "mouseup", { capture: true }).pipe(safeTakeUntilDestroyed(this.destroyRef)).subscribe((event) => {
    ...
    fromEvent(this.document, "keydown", { capture: true }).pipe(safeTakeUntilDestroyed(this.destroyRef)).subscribe((event) => {
  ...
  createOverlay() {
    ...
    const portal = createPortal(this.config.content, this.viewContainerRef, Injector.create({
      ...
      providers: [
        ...
        { provide: _NgpOverlay, useValue: this },
    ...
    this.scrollStrategy = this.config.scrollBehaviour === "block" ? new BlockScrollStrategy(this.viewportRuler, this.document) : new NoopScrollStrategy();
  ...
  setupPositioning(overlayElement) {
    const strategy = getComputedStyle(overlayElement).position === "fixed" ? "fixed" : this.config.strategy || "absolute";
   ...
   */
  computePosition(overlayElement, strategy = "absolute") {
    return __async(this, null, function* () {
      const middleware = [offset2(this.config.offset || 0), shift2()];
      ...
      const position = yield computePosition2(this.config.triggerElement, overlayElement, {
  ...
  destroyOverlay() {
    return __async(this, null, function* () {
      ...
      this.disposePositioning?.();
      this.disposePositioning = void 0;
      yield portal.detach();
      this.isOpen.set(false);
      this.finalPlacement.set(void 0);
      this.scrollStrategy.disable();
      this.scrollStrategy = new NoopScrollStrategy();
    });
  }
...
//# sourceMappingURL=chunk-QDL3VOQ2.js.map
