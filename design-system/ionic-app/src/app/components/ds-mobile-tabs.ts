import { Component, Input, Output, EventEmitter, signal, OnInit, OnDestroy, inject, PLATFORM_ID } from '@angular/core';
...
export class DsMobileTabsComponent implements OnInit, OnDestroy {
